Feature: Purchase a book on amazon.com
  ...
  Scenario Outline: Purchase a book
    ...
    Examples:
      | nameBook             | nameBookOptOne                                 | nameBookOptTwo                           | assertOneAuthor | assertTwoSoldBy | assertThree |
      | A Practitioner's Guide to Software Test Design | A practitioner's Guide to Software Test Design | Paperback tab was not shown pre-selected | Lee Copeland    | RAE global      | 0           |
